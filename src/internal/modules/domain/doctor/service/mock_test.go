...
// Source: hospital/src/internal/modules/domain/doctor/service (interfaces: IDoctorRepo)
...
func (m *MockIDoctorRepo) Delete(arg0 context.Context, arg1 int32) error {
	m.ctrl.T.Helper()
...
func (m *MockIDoctorRepo) GetById(arg0 context.Context, arg1 int32) (*dto.Doctor, error) {
	m.ctrl.T.Helper()
...
func (m *MockIDoctorRepo) Update(arg0 context.Context, arg1 int32, arg2 *dto.UpdateDoctor) (*dto.Doctor, error) {
	m.ctrl.T.Helper()
